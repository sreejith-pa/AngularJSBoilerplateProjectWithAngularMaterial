...
If you're using OS X or Windows, the best way to install Node.js is to use one of the installers from nodejs.org(https://nodejs.org/en/)
Always install LTS Version

clone the project from this repo

Next open terminal/ Command window and run npm install
npm install 
sudo npm install --global gulp-cli  (sudo is mac command)
npm install gulp

To build and run the project run gulp dev in angular folder path in terminal or command window, this will automatically opens the bowser with the appplication
